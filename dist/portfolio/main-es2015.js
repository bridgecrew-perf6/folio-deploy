...
/* harmony import */ var _present_present_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./present/present.component */ "./src/app/present/present.component.ts");
...
/* harmony import */ var _realise_realise_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./realise/realise.component */ "./src/app/realise/realise.component.ts");
...
const routes = [
    { path: 'home', component: _present_present_component__WEBPACK_IMPORTED_MODULE_7__["PresentComponent"] },
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _present_present_component__WEBPACK_IMPORTED_MODULE_7__["PresentComponent"],
            ...
            _realise_realise_component__WEBPACK_IMPORTED_MODULE_12__["RealiseComponent"],
...
/* harmony import */ var _models_commentModels__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../models/commentModels */ "./src/app/models/commentModels.ts");
...
let ContactComponent = class ContactComponent {
    constructor(formBuilder, contactService, route) {
    ...
    ngOnChanges(changes) {
        for (const devisType in changes) {
            ...
            if (this.devisType != this.cacheDevis && changes[devisType].firstChange == false) {
                ...
                //this.msg = "Pour un devis, merci de ne pas effacer le décorateur"+this.devisType+" saisie automatiquement ddans le champs text.";
                if (this.infoClass) {
    ...
    onSubmitForm() {
        const formValue = this.commentForm.value;
        const newComment = new _models_commentModels__WEBPACK_IMPORTED_MODULE_4__["Comment"](formValue['email'], formValue['content']);
        this.msg = "MongoDB en maintenance. La partie messageri est momentanément indisponible. Vous pouvez toujours me contacter par mail ou par téléphone tout en haut de la page.";
        this.toastView(this.msg);
        this.toastClass = false;
        this.infoClass = false;
...
], ContactComponent.prototype, "devisType", void 0);
...
let MessageComponent = class MessageComponent {
    ...
    ngOnInit() {
        this.messageSubscription = this.contactService.commentSubject.subscribe((messages) => {
...
let PresentComponent = class PresentComponent {
    constructor(router) {
        this.devis = "";
        router.events.subscribe(s => {
            if (s instanceof _angular_router__WEBPACK_IMPORTED_MODULE_2__["NavigationEnd"]) {
...
PresentComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
];
PresentComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-present',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./present.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/present/present.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./present.component.css */ "./src/app/present/present.component.css")).default]
    })
], PresentComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RealiseComponent", function() { return RealiseComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");


let RealiseComponent = class RealiseComponent {
    constructor() { }
    ngOnInit() {
    }
};
RealiseComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-realise',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./realise.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/realise/realise.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./realise.component.css */ "./src/app/realise/realise.component.css")).default]
    })
], RealiseComponent);
...
let ContactService = class ContactService {
    constructor(http) {
        this.http = http;
        this.reqHeader = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({ 'Content-Type': 'application/json', 'No-Auth': 'True' });
    ...
    sendComment(comment) {
        return new Promise((resolve, reject) => {
            this.http.post('/api/message', comment).subscribe((response) => {
                resolve(response);
            }, (error) => {
                reject(error);
            });
    ...
    //Get All message
    getAllMessage() {
        this.http.get('/api/message', { headers: this.reqHeader })
            .subscribe((comment) => {
            if (comment) {
                this.comments = comment;
                console.log(this.comments);
...
module.exports = __webpack_require__(/*! C:\Users\anliw\Desktop\folio\src\main.ts */"./src/main.ts");
